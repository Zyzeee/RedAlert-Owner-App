...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      setIsLoading(false);
      navigation.navigate('OwnerLoginScreen'); // Navigate to the home screen after loading
    }, 2000);
  ...
  return (
    ...
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
      <Image
        ...
        style={{ width: 200, height: 200, resizeMode: 'contain' }} // Adjust the width and height as needed
      />
